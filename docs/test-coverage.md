...
| `Dynamic.Json.EfCore.PostgreSql` | Provider registration boundary | Covered | Docker-free tests verify options metadata, idempotent `UseDynamicJsonPostgreSql()` registration, fluent builder identity, and composition with Npgsql configuration. |
